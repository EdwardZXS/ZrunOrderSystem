			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">所属商户ID</th>
						<th class="center">创建人员ID</th>
						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td>
										<td>${var.MERCHANTID}</td>
										<td>${var.USERID}</td>
										<td>${var.PRODUCT_NAME}</td>
										<td>${var.PRODUCT_ANOTHERNAME}</td>
										<td>${var.PRODUCT_PRICE}</td>
										<td>${var.PRODUCT_DISCOUNTE}</td>
										<td>${var.PRODUCT_SAVE}</td>
										<td>${var.PRODUCT_SALE_AMOUNT}</td>
										<td>${var.ZD_ID}</td>
										<td>${var.SIZE}</td>
										<td>${var.COLOR}</td>
										<td>${var.STOCK}</td>
										<td>${var.INPUTDATE}</td>
										<td>${var.PRODUCTSTATUS}</td>
