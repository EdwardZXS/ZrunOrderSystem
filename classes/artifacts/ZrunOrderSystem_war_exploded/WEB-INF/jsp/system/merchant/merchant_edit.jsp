	...
	<form action="merchant/${msg }.do" name="Form" id="Form" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				...
				<td style="width:70px;text-align: right;padding-top: 13px;">所属销售ID:</td>
				<td>
					...
					<select class="chzn-select" name="USERID" id="USERID" data-placeholder="请选择销售" style="vertical-align:top;width: 220px;">
						...
						<c:forEach items="${userList}" var="user">
							<option value="${user.USER_ID}" <c:if test="${CUR_USER.USER_ID==user.USER_ID}">selected</c:if>>${user.NAME}</option>
			...
			<tr>
				...
				<td colspan="3">
					...
					<textarea name="EXPLAINS" id="EXPLAIN" style="width:500px" rows="5">${pd.EXPLAINS}</textarea>
				</td>
			</tr>
			<tr>
