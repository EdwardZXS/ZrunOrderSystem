...
<body>
	<form action="packages/${msg }.do" name="Form" id="Form" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">备注预留字段:</td>
				<td><input type="text" name="BAK30" id="BAK30" value="${pd.BAK30}" maxlength="32" placeholder="这里输入备注预留字段" title="备注预留字段"/></td>
			</tr>
			<tr>
