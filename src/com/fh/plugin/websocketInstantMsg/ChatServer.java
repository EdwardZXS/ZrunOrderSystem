...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("FHadminqq421459300")){
			this.userjoin(message.replaceFirst("FHadminqq421459300", ""),conn);
		}if(null != message && message.startsWith("LeaveFHadminqq421459300")){
			this.userLeave(conn);
