package com.fh.service.system.merchant;
...
public class MerchantService {
	...
	*/
	public List<PageData> list(Page page)throws Exception{
		return (List<PageData>)dao.findForList("MerchantMapper.datalistPage", page);
	}
	...
	*/
	public List<PageData> listAll(PageData pd)throws Exception{
		return (List<PageData>)dao.findForList("MerchantMapper.listAll", pd);
	}
	...
	*/
	public PageData findById(PageData pd)throws Exception{
		return (PageData)dao.findForObject("MerchantMapper.findById", pd);
	}
